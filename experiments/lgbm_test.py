# -*- coding: utf-8 -*-
"""
# This script contains experimental code for validating lgbm models 
# during the early stages of the project. It was not used in production.
"""

# 變更當前工作目錄
import os
new_directory = r"lgbm_path"
...
for start, end in zip(week_start_dates, week_end_dates):
    ...
    def objective(trial, X, y):
        ...
        param = {
            ...
            'num_leaves': trial.suggest_int('num_leaves', 80, 500, step=20),
        ...
        param = {
            ...
            'num_leaves': trial.suggest_int('num_leaves', 8, 600, step=20),
        ...
        for train_index, test_index in cv.split(X_train, y_train):  
            ...
            # Fit the model
            optuna_model = lgb.LGBMRegressor(**param)
    ...
    if  loop_month != n_month :
        ...
        # n_trials為要跑的試驗次數
        study.optimize(func, n_trials = 50, n_jobs=5)
    ...
    param = {
        ...
        "metric": "rmse",
        'n_estimators': 581,
        'learning_rate': 0.028958,
        'min_data_in_leaf': 200,
        'max_depth': 5,
        'num_leaves': 428,
        'lambda_l1': 60,
        'lambda_l2': 40,
        'bagging_fraction': 0.730391,
        'feature_fraction': 0.525772,
        'min_gain_to_split': 10.797854
    }
